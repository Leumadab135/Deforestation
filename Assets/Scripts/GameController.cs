...
namespace Deforestation
{
    public class GameController : Singleton<GameController>
    {
        ...
        [SerializeField] protected GameObject _FPSAim;
        ...
        internal void MachineMode(bool machineMode)
        {
            ...
            if (machineMode)
            {
                ...
                //Cursor aim
                _FPSAim.SetActive(false);
                Cursor.SetCursor(_cursorTexture, Vector2.zero, UnityEngine.CursorMode.Auto);
                Cursor.visible = true;
            }
            else
            {
